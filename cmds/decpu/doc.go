...
// decpu - connection to dynamically discovered CPU server over SSH protocol
//
// Synopsis:
//
//	decpu [OPTIONS] [URI] [CMD] [ARGS]
//
// Advisory:
//
...
//		  default is dnssd://_ncpu._tcp?arch=$GOARCH&os=$GOOS
//	  CMD is the command to run on the remote, default is the shell
//		 ARGS are the arguments to run for the CMD on remote, no defauls
//		 NOTE: you must specify a URI (at least .) if you specify a CMD.
//
